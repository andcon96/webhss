            ...
            <div class="panel-body">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="conbr" class="col-md-2 col-form-label text-md-right">{{ __('Nomor CO') }}</label>
                        <div class="col-md-3">
                            <input id="conbr" type="text" class="form-control" name="conbr" autocomplete="off" value="" readonly>
                        </div>
                    ...
                    <div class="form-group row">
                        <label for="status" class="col-md-2 col-form-label text-md-right">{{ __('Status CO') }}</label>
                        <div class="col-md-3">
            ...
            <div class="panel-body">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="conbr" class="col-md-2 col-form-label text-md-right">{{ __('Nomor CO') }}</label>
                        <div class="col-md-3">
                            <input id="dconbr" type="text" class="form-control" name="conbr" autocomplete="off" value="" readonly>
                        </div>

                        <label for="cust" class="col-md-2 col-form-label text-md-right">{{ __('Customer') }}</label>
                        <div class="col-md-3">
                            <input id="dcust" type="text" class="form-control" name="cust" autocomplete="off" value="" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="status" class="col-md-2 col-form-label text-md-right">{{ __('Status CO') }}</label>
                        <div class="col-md-3">
                            <input id="dstatus" type="text" class="form-control" name="status" autocomplete="off" value="" readonly>
                        </div>
                    </div>
                    <div id="form-group row">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <div class="modal-content">
            ...
            <form action="{{route('customerorder.destroy', 'role')}}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="container">
                        <div class="row">
                            Are you sure you want to delete CO Number :&nbsp; <strong><a name="temp_uname" id="temp_uname"></a></strong>
                            &nbsp;?
                        </div>
                    </div>
