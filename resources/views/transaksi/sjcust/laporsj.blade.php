    ...
    <form action="{{ route('updateSJ') }}" method="POST" id="submit">
        ...
        <div class="row">
            <div class="form-group row col-md-12">
                ...
                <div class="col-md-3">
                    <input id="sonbr" type="text" class="form-control" name="sonbr"
                        value="{{ $data->getSOMaster->so_nbr }}" autocomplete="off" maxlength="24" autofocus readonly>
                </div>
                <label for="sjnbr" class="col-md-3 col-form-label text-md-right">Nomor SPK</label>
                <div class="col-md-3">
                    <input id="sjnbr" type="text" class="form-control" name="sjnbr" value="{{ $data->sj_nbr }}"
                        autocomplete="off" maxlength="24" autofocus readonly>
            ...
            <div class="form-group row col-md-12">
                ...
                <div class="col-md-3">
                    <input id="domain" type="text" class="form-control" name="domain"
                        value="{{ $data->getTruck->truck_domain }}" autocomplete="off" maxlength="24" autofocus readonly>
                </div>
                ...
                <div class="col-md-3">
                    <input id="truck" type="text" class="form-control" name="truck"
                        value="{{ $data->getTruck->truck_no_polis }}" autocomplete="off" maxlength="24" autofocus readonly>
                </div>
            </div>
            <div class="form-group row col-md-12">
                <label for="shipfrom" class="col-md-2 col-form-label text-md-right">Ship From</label>
                <div class="col-md-3">
                    <input id="shipfrom" type="hidden" class="form-control" name="shipfrom"
                        value="{{ $data->getSOMaster->so_ship_from }}" autocomplete="off" maxlength="24" autofocus readonly>
                    <input id="" type="text" class="form-control" name=""
                        value="{{ $data->getSOMaster->so_ship_from }} -- {{ $data->getSOMaster->getShipFrom->sf_desc ?? '' }}"
                        autocomplete="off" maxlength="24" autofocus readonly>
                </div>
                <label for="shipto" class="col-md-3 col-form-label text-md-right">Ship To</label>
                <div class="col-md-3">
                    <input id="shipto" type="hidden" class="form-control" name="shipto"
                        value="{{ $data->getSOMaster->so_ship_to }}" autocomplete="off" maxlength="24" autofocus readonly>
                    <input id="" type="text" class="form-control" name=""
                        value="{{ $data->getSOMaster->so_ship_to }} -- {{ $data->getSOMaster->getShipTo->cs_shipto_name ?? '' }}"
                        autocomplete="off" maxlength="24" autofocus readonly>
                </div>
            </div>
            <div class="form-group row col-md-12">
                ...
                <div class="col-md-3">
                    <input id="type" type="text" class="form-control" name="type"
                        value="{{ $data->getSOMaster->getCOMaster->co_type }}" autocomplete="off" maxlength="24"
                        autofocus readonly>
                </div>
            </div>
            <div class="form-group row col-md-12">
                ...
                <div class="col-md-3">
                    <input id="customer" type="text" class="form-control" name="customer"
                        value="{{ $data->getSOMaster->getCOMaster->co_cust_code }}" autocomplete="off" maxlength="24"
                        autofocus readonly>
                </div>
                ...
                <div class="col-md-3">
                    <input id="effdate" type="text" class="form-control" name="effdate"
                        value="{{ \Carbon\Carbon::now()->toDateString() }}" autocomplete="off" maxlength="24" autofocus>
                    <input type="hidden" id="so_date" name="so_date"
                        value="{{ $data->getSOMaster->created_at->format('Y-m-d') }}">
                    <input type="hidden" id="so_due_date" name="so_due_date"
                        value="{{ $data->getSOMaster->so_due_date }}">
                </div>
            </div>
            <div class="form-group row col-md-12">
                <label for="listsangu" class="col-md-2 col-form-label text-md-right">List Sangu</label>
                <div class="col-md-3">
            ...
            <div class="form-group row col-md-12">
                ...
                <div class="col-md-9">
                    <input id="remarkCO" type="text" class="form-control"
                        value="{{ $data->getSOMaster->getCOMaster->co_remark }}" autocomplete="off" autofocus readonly>
                </div>
            </div>
            <div class="form-group row col-md-12">
