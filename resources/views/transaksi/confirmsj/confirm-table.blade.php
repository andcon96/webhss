    ...
    <table class="table table-bordered edittable" id="editTable" width="100%" cellspacing="0">
        ...
        <tbody id="edittable">
            ...
            <tr>
                ...
                <td>
                    <input type="number" name="qtyangkut[]" value="{{$datas->sjd_qty_ship}}" class="form-control" readonly>
                </td>
                <td>
                    ...
                    <input type="number" name="qtyakui[]" value="{{$datas->sjd_qty_ship}}" class="form-control" readonly>
                </td>
            </tr>
            @empty
            <tr>
