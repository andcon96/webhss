    ...
    <div class="row">
        ...
        <div class="form-group row col-md-12">
            ...
            <div class="col-md-3" style="display: {{!empty($data->getGandeng->gandeng_code) ? '' : 'none'}}">
                <input id="gandengan" type="text" class="form-control" name="truck" value="{{isset($data->getGandeng->gandeng_code) ? $data->getGandeng->gandeng_desc : ''}}" autocomplete="off" maxlength="24" readonly>
            </div>
            @endif
        </div>
        <div class="form-group row col-md-12">
