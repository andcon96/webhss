...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item active">Lapor Kerusakan - Assign Tindakan</li>
</ol>
@endsection

@section('content')
<form action="{{ route('UpAssignRemarks',$data->id) }}" id="submit" method="POST">
    @csrf
    @method('PUT')
    <div class="row">
        ...
        <div class="form-group row col-md-12">
            ...
            <label for="Kilometer" class="col-md-2 col-form-label text-md-right">Kilometer</label>
            <div class="col-md-3">
                <input id="Kilometer" type="number" class="form-control" name="km" value="{{$data->kr_km}}" autocomplete="off" autofocus readonly>
            </div>
        </div>
        <div class="form-group row col-md-12">
