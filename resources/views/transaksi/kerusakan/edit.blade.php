...
<form action="{{ route('laporkerusakan.update',$data->id) }}" id="submit" method="POST">
    ...
    <div class="row">
        ...
        <div class="form-group row col-md-12">
            ...
            <div class="col-md-3">
                <input id="gandeng" type="text" class="form-control" name="gandeng" value="{{isset($data->kr_gandeng) ? $data->kr_gandeng : ''}}" autocomplete="off" maxlength="24" required autofocus>
            </div>
