         ...
         <div class="form-group row mr-2 ml-2">
            <div class="col-md-10 offset-md-1">
               <table id="createTable" class="table order-list" style="table-layout: fixed;">
                  <thead>
                        <tr>
                           <td style="text-align: center; width:20%">Domain</td>
...
<script>
   ...
   $("#addrow").on("click", function() {
      ...
      cols += '<td>';
      cols += '<select name="domain[]" id="domain" class="form-control domain selectpicker"style="border: 1px solid #e9ecef" name="part[]" data-size="5" data-live-search="true" required autofocus>';
      ...
      cols += '<td>';
      cols += '<input type="text" class="form-control price" name="price[]" value="" onkeydown="return false;" style="caret-color: transparent !important;background-color:#d3d3d3;"   required/>';
      cols += '</td>';

      cols += '<td data-title="Action"><input type="button" class="btncheck btn btn-info btn-focus mr-2"  value="Check"><input type="button" class="ibtnDel btn btn-danger btn-focus" value="Delete"></td>';
      cols += '</tr>'
      counter++;
