...
class QxtendServices
{
                ...
                foreach ($data['iddetail'] as $key => $datas) {
                  $qdocbody .=    '<salesLine>
                                    ...
                                    <salesLineTransComment>
                                      ...
                                      <cmtCmmt>'.$data['sjcustomer'].'</cmtCmmt>
                                      <cmtCmmt>'.$data['truck'].'</cmtCmmt>
                                    </salesLineTransComment>
                                  </salesLine>';
                }
  ...
  //load nopol truck/gandengan
  public function qxLoadNopol($jenis,$nopol){
    ...
    foreach($nopol as $np){
      ...
      '
      <generalizedCode>
        <codeFldname>'.$jenis.'</codeFldname>
        <codeValue>'.$np[1].'</codeValue>
        <codeCmmt>'.$np[0].'</codeCmmt>
        </generalizedCode>
      '
      
      // <codeGroup>text</codeGroup>
    ;
    }
